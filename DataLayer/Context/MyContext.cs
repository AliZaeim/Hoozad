...
namespace DataLayer.Context
{
    ...
    public class MyContext : DbContext
    {
        ...
        public DbSet<CellphoneBank> CellphoneBanks { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                ...
                new Role { RoleId = 2, RoleTitle = "مشتری", RoleName = "Customer" },
                new Role { RoleId = 3, RoleTitle = "همکار فروش", RoleName = "Marketer" },
                new Role { RoleId = 4, RoleTitle = "اپراتور", RoleName = "Operator" });
            #endregion
            #region Users
